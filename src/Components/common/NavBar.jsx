...
import logo from "../../assets/Logo/kill Boost.png"
...
const NavBar = ({ setProgress }) => {
    ...
    return (
        <div className={` flex sm:relative bg-black w-screen relative z-40 h-14 items-center justify-center border-b-[1px] border-b-richblack-700 translate-y-  transition-all duration-500`}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                <Link to='/' onClick={() => { dispatch(setProgress(100)) }}>
                    <img src={logo} width={150} alt="SKill Boost" height={14}></img>
                </Link>
                {/* mobile Navbar */}
                {
